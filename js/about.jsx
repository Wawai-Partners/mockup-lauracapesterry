...
(function () {
  ...
  function AboutPage() {
    ...
    const careerAwards = [
      'Benny Award for Innovative Marketing from the National Association of Printers and Lithographers',
      'Two-Time Award Winner for Innovative Marketing from Life Fitness',
      'Lifetime Achievement Award Winner in Innovative Marketing from Leisure Fitness',
      'Appeared on Cover of FAST Company Magazine for Innovative Marketing',
      '#2 Rookie of the Year Award from N2 Publishing',
      '#2 in Qualified Expansion Sales Award from N2 Publishing',
    ];
      ...
      <div>
        ...
        <section className="about-strip">
          <div className="about-strip__inner reveal">
            <p className="ed-eyebrow ed-eyebrow--light" style={{ color: 'var(--lct-sky-500)' }}>Meet Laura · Fractional CMO + AI Consultant</p>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 19, lineHeight: 1.6, color: '#fff', margin: '0 0 14px' }}>
        ...
        <section className="bg-tint section">
          <window.Container>
            <div className="about-two">
              <div className="reveal">
                <h2 className="ed-serif" style={{ fontSize: 'var(--fs-h3)', marginBottom: 14 }}>A steady guide when things feel unclear</h2>
              ...
              <div className="reveal">
                <h2 className="ed-serif" style={{ fontSize: 'var(--fs-h3)', marginBottom: 14 }}>Built from real-world experience</h2>
        ...
        <section id="trust" className="bg-card section">
          <window.Container>
            <div className="about-trust__grid">
              ...
              <div className="reveal">
                <h2 className="ed-serif" style={{ fontSize: 'var(--fs-h3)', marginBottom: 16 }}>Why Businesses Trust Laura</h2>
            ...
            <div className="reveal" style={{ marginTop: 44, maxWidth: 820 }}>
              <p className="ed-eyebrow">Experience that informs judgment</p>
              <ul className="about-explist">
                {judgment.map((j, i) => (
                  <li key={i}><i className="fa-solid fa-circle-check"></i><span>{j}</span></li>
                ))}
              </ul>
            </div>
          </window.Container>
        ...
        <section className="bg-card section">
          <window.Container>
            ...
            <div className="reveal" style={{ textAlign: 'center', marginTop: 48, maxWidth: 820, marginLeft: 'auto', marginRight: 'auto' }}>
              <h3 className="ed-serif" style={{ fontSize: 'var(--fs-h4)', marginBottom: 12 }}>Additional Training &amp; Certifications</h3>
          ...
          <window.Container>
            ...
            <div className="about-testi" style={{ marginTop: 48 }}>
              <div className="reveal">
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: 15, color: 'var(--color-primary)', margin: '0 0 26px' }}>Testimonial from Guy Williams, PRECOR</p>
        ...
        <section className="bg-page section">
          <window.Container>
            <div className="card reveal" style={{ maxWidth: 640, margin: '0 auto', boxShadow: 'var(--shadow-md)', padding: 40 }}>
              <h2 className="ed-serif" style={{ fontSize: 'var(--fs-h2)', textAlign: 'center', margin: '0 0 10px' }}>Let’s Start a Conversation</h2>
              ...
              <form onSubmit={(e) => { e.preventDefault(); toast('Thanks! Laura will reach out shortly.'); }} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ textAlign: 'center', marginTop: 6 }}><Button type="submit">Let’s do this!</Button></div>
              </form>
            </div>
          </window.Container>
        </section>
