        ...
        <section className="bg-tint section--sm">
          <window.Container>
            <div className="reveal" style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', paddingTop: 24, paddingBottom: 24 }}>
              ...
              <p className="lead">A short, intentional conversation to understand a business\u2019s goals, find low-hanging opportunities, and recommend a smart next step. No pressure — just clarity.</p>
            </div>
          </window.Container>
        </section>
