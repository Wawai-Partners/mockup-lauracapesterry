...
(function () {
  ...
  function GivingBackPage() {
    const orgs = [
      ...
      ['fa-users', 'The Horseshoe Club', 'Through the Horseshoe Club, supporters help care for the therapy horses at ROCK, Ride On Center for Kids. These beloved horses play a meaningful role in helping children, adults, and veterans experience growth, healing, confidence, and connection.'],
          ...
          <window.Container>
            <div className="reveal" style={{ textAlign: 'center', maxWidth: 620, margin: '0 auto' }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--fs-lead)', lineHeight: 1.6, color: 'rgba(255,255,255,0.92)', margin: '0 0 28px' }}>
                Want to learn more about how a business can serve the Georgetown community? Let's talk.
              </p>
